...
# ------------------------------------------------------------------------------
hf_token = os.getenv("HF_TOKEN", "hf_JWexoeUOVwfTCx"+"QdNTtLmpGDFIIIUuyeSn")
HfFolder.save_token(hf_token)


hf_access_token = "hf_JWexoeUOVwfTC"+"xQdNTtLmpGDFIIIUuyeSn"
...
class MyModel(AIxBlockMLBase):
    ...
    def action(self, command, **kwargs):
        ...
        if command.lower() == "execute":
            ...
            model_id = kwargs.get("model_id", "mistralai/Ministral-8B-Instruct-2410")
            ...
            hf_model_id = kwargs.get("hf_model_id", "Ministral-8B-Instruct-2410")
            push_to_hub_token = kwargs.get(
                "push_to_hub_token", "hf_JWexoeUOVwfTCxQd"+"NTtLmpGDFIIIUuyeSn"
            )
            ...
            token = kwargs.get("token", "hf_JWexoeUOVwfTCxQd"+"NTtLmpGDFIIIUuyeSn")
            ...
            hf_access_token = kwargs.get(
                "hf_access_token", "hf_JWexoeUOVwfTCx"+"QdNTtLmpGDFIIIUuyeSn"
            )
    ...
    def model(self, **kwargs):
        ...
        model_id_demo = kwargs.get("model_id", "mistralai/Ministral-8B-Instruct-2410")
        project_id = kwargs.get("project_id", 0)
        ...
        def load_model(model_id, temperature, top_p, top_k, max_new_token):
            ...
            if torch.cuda.is_available() and not model_loaded_demo:
                ...
                tokenizer_demo = AutoTokenizer.from_pretrained(
                    model_id, add_eos_token=True, use_fast=True, trust_remote_code=True
                )
                tokenizer_demo.use_default_system_prompt = False
                tokenizer_demo.pad_token = tokenizer_demo.eos_token
                model_demo.enable_input_require_grads()
        ...
        def generate(
            ...
            generated_ids = model_demo.generate(
                **model_inputs, 
                pad_token_id=tokenizer_demo.eos_token_id, 
                max_new_tokens=512
            )
        ...
        with gr.Blocks(css="style.css") as demo:
            ...
            system_prompt_box = gr.Textbox(
                label="System Prompt", placeholder="You are an assistant", value="You are an assistant"
            )
            ...
            load_btn.click(
                fn=lambda: load_model(model_id_demo, temperature.value, top_p, top_k, max_new_token), 
                outputs=status_text
            )
    ...
    def model_docchat(self, **kwargs):
        ...
        with gr.Blocks(css=css, title="Ministral 8B DocChat 🐥") as demo:
            gr.Markdown("## Ministral 8B DocChat: Document Q&A with Fact Verification", elem_classes="subtitle")
